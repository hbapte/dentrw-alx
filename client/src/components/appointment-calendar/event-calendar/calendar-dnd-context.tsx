...
import { EventItem, type CalendarEvent } from "@/components/appointment-calendar/event-calendar"
...
// Create the context
const CalendarDndContext = createContext<CalendarDndContextType | undefined>(undefined)
