// client\src\components\event-calendar\event-calendar.tsx
"use client"
...
export interface EventCalendarProps {
  ...
  doctors?: { id: string; name: string; color: EventColor }[]
              ...
              <Popover>
                ...
                <PopoverContent className="w-48 p-2">
                  <div className="grid gap-2">
                    <div className="text-sm font-medium text-muted-foreground/65 uppercase mb-1">Calendars</div>
                    {etiquettes.map((item) => (
