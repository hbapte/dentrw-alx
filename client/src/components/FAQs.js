        ...
        <div className="flex flex-col divide-y divide-gray-300 sm:mx-12 lg:px-12 xl:px-32 mb-10">
          <details>
            ...
            <div className="px-4 pb-4">
              <p>
                {" "}
                DentRw offers a wide range of dental services, including preventative care, virtual consultation, cleanings, fillings, root canals, extractions and more.
                Our Experienced team is dedicated to  providing exceptional oral health care to our patients
              </p>
            </div>
          </details>
          <details>
            <summary className="py-2 outline-none cursor-pointer focus:font-semibold">
              {" "}
              What are the effects of taditional habit known as Gukura Ibyinyo/Tooth bud extraction?{" "}
            </summary>
            <div>
              ...
              <p className="px-4 pb-4">
              Some potential effects of tooth bud extraction include: Misalignment of Teeth,
          ...
          <details>
            ...
            <div>
              ...
              <p className="px-4 pb-4">
                {" "}
                Besides our online booking system, you can also give us a call. We offer flexible scheduling options to ensure
                that you can receive the care you need at a time that works for you.
              </p>
            </div>
          </details>
        </div>
