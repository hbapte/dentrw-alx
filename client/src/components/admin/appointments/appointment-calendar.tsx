...
import { EventCalendar, type CalendarEvent } from "@/components/appointment-calendar/admin"
import { CalendarProvider } from "@/components/appointment-calendar/admin/calendar-context"
...
export function AdminAppointmentCalendarComponent() {
  ...
  const isDoctorVisible = useCallback(
    (doctorId: string) => visibleDoctorIds.includes(doctorId),
    [visibleDoctorIds]
  )
  ...
  const handleEventDelete = async (eventId: string) => {
    try {
      await AppointmentService.cancelAppointment(eventId, "Cancelled by admin")
