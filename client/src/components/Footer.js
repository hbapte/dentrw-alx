      ...
      <div className="py-2 grid lg:grid-cols-2 gap-7 items-center">
        ...
        <div>
          <form class="flex">
            ...
            <div class="flex-1 mr-4 sm:mr-0">
              <div class="relative">
                <input
                  type="email"
                  id="UserEmail"
                  placeholder="hbapte@email.rw"
                  class="block w-full px-4 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent sm:text-sm"
                />
      ...
      <div className="container  flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            ...
            <span className="self-center text-2xl font-semibold">DentRW</span>
          </a>
        </div>
