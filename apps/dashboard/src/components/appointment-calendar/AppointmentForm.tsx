  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            {!checkingAvailability && isAvailable === false && (
              <p className="mt-1 text-sm text-red-600">Doctor is not available at this time</p>
            )}
            {!checkingAvailability && isAvailable === true && (
              <p className="mt-1 text-sm text-green-600">Doctor is available at this time</p>
            )}
          </div>
      ...
      <div className="flex justify-end space-x-3">
        ...
        <button
          type="submit"
          disabled={isSubmitting || isAvailable === false || checkingAvailability}
