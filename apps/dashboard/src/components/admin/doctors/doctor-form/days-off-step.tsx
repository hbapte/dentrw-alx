  ...
  return (
    <motion.div className="space-y-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="space-y-1">
                      <h4 className="font-medium text-gray-900 dark:text-white">{dayOff.name}</h4>
            ...
            <Card className="border-2 border-blue-200 dark:border-blue-800 shadow-lg">
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="dayOffName" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      Day Off Name
                    </Label>
                    <Input
                      id="dayOffName"
                      ...
                      className="mt-1 h-10 border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:border-blue-500 focus:ring-blue-500/20"
                    />
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => setNewDayOff({ ...newDayOff, repeatYearly: checked as boolean })}
      ...
      {!showAddForm && (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <Button
            ...
            className="w-full h-12 border-2 border-dashed border-gray-300 dark:border-gray-600 hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-200"
          >
      ...
      {formData.daysOff && formData.daysOff.length > 0 && (
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-blue-900 dark:text-blue-300">Total Days Off</span>
            <Badge className="bg-blue-600 text-white">{formData.daysOff.length}</Badge>
          </div>
        </motion.div>
      )}
    </motion.div>
