...
import { DoctorEventDialog } from "./doctor-event-dialog"
...
export interface DoctorEventCalendarProps {
  ...
  patients?: { id: string; name: string; color: EventColor }[]
  isDoctorView?: boolean
  currentUser?: any
}

export function DoctorEventCalendar({
  events = [],
  onEventAdd,
  onEventUpdate,
  onEventDelete,
              ...
              <Popover>
                ...
                <PopoverContent className="w-48 p-2">
                  <div className="grid gap-2">
                    <div className="text-sm font-medium text-muted-foreground/65 uppercase mb-1">Patients</div>
                    {etiquettes.map((item) => (
